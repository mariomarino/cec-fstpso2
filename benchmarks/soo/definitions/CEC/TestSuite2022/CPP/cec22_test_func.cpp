...
void cec22_test_func(py::array_t<double, 2> ndarray_x, py::array_t<double, 1> ndarray_f, int nx, int mx, int func_num)
{
...
PYBIND11_MODULE(cec22_test_func, m)
{
    m.doc() = "cec22_test_func pybind11 plugin"; // optional module docstring
    m.def("cec22_test_func", &cec22_test_func,
    "CEC22 Test Function Suite for Single Objective Bound Constrained Numerical Optimization",
