...
void cec21_basic_func(py::array_t<double, 2> ndarray_x, py::array_t<double, 1> ndarray_f, int nx, int mx, int func_num)
{
    py::buffer_info buf_x = ndarray_x.request();
    py::buffer_info buf_f = ndarray_f.request();
    double *x = static_cast<double *>(buf_x.ptr);
    double *f = static_cast<double *>(buf_f.ptr);
	...
	if (ini_flag==0)
	{
	    std::ifstream file;  // fscanf doesn't work
//		FILE *fpt;
		char FileName[256];
		free(M);
		free(OShift);
...
void cec21_bias_func(py::array_t<double, 2> ndarray_x, py::array_t<double, 1> ndarray_f, int nx, int mx, int func_num)
{
    py::buffer_info buf_x = ndarray_x.request();
    py::buffer_info buf_f = ndarray_f.request();
    double *x = static_cast<double *>(buf_x.ptr);
...
void cec21_bias_rot_func(py::array_t<double, 2> ndarray_x, py::array_t<double, 1> ndarray_f, int nx, int mx, int func_num)
{
    py::buffer_info buf_x = ndarray_x.request();
    py::buffer_info buf_f = ndarray_f.request();
    double *x = static_cast<double *>(buf_x.ptr);
...
void cec21_bias_shift_func(py::array_t<double, 2> ndarray_x, py::array_t<double, 1> ndarray_f, int nx, int mx, int func_num)
{
	py::buffer_info buf_x = ndarray_x.request();
    py::buffer_info buf_f = ndarray_f.request();
    double *x = static_cast<double *>(buf_x.ptr);
...
void cec21_bias_shift_rot_func(py::array_t<double, 2> ndarray_x, py::array_t<double, 1> ndarray_f, int nx, int mx, int func_num)
{
	py::buffer_info buf_x = ndarray_x.request();
    py::buffer_info buf_f = ndarray_f.request();
    double *x = static_cast<double *>(buf_x.ptr);
...
void cec21_rot_func(py::array_t<double, 2> ndarray_x, py::array_t<double, 1> ndarray_f, int nx, int mx, int func_num)
{
	py::buffer_info buf_x = ndarray_x.request();
    py::buffer_info buf_f = ndarray_f.request();
    double *x = static_cast<double *>(buf_x.ptr);
...
void cec21_shift_func(py::array_t<double, 2> ndarray_x, py::array_t<double, 1> ndarray_f, int nx, int mx, int func_num)
{
	py::buffer_info buf_x = ndarray_x.request();
    py::buffer_info buf_f = ndarray_f.request();
    double *x = static_cast<double *>(buf_x.ptr);
...
void cec21_shift_rot_func(py::array_t<double, 2> ndarray_x, py::array_t<double, 1> ndarray_f, int nx, int mx, int func_num)
{
	py::buffer_info buf_x = ndarray_x.request();
    py::buffer_info buf_f = ndarray_f.request();
    double *x = static_cast<double *>(buf_x.ptr);
...
PYBIND11_MODULE(cec21_test_func, m)
{
    m.doc() = "cec21_test_func pybind11 plugin"; // optional module docstring
    m.def("cec21_basic_func", &cec21_basic_func,
    "Basic",
    "x"_a, "f"_a, "nx"_a, "mx"_a, "func_num"_a);
    m.def("cec21_bias_func", &cec21_bias_func,
    "Bias",
    "x"_a, "f"_a, "nx"_a, "mx"_a, "func_num"_a);
    m.def("cec21_bias_rot_func", &cec21_bias_rot_func,
    "Bias & Rotation",
    "x"_a, "f"_a, "nx"_a, "mx"_a, "func_num"_a);
    m.def("cec21_bias_shift_func", &cec21_bias_shift_func,
    "Bias & Shift",
    "x"_a, "f"_a, "nx"_a, "mx"_a, "func_num"_a);
    m.def("cec21_bias_shift_rot_func", &cec21_bias_shift_rot_func,
    "Bias & Shift & Rotation",
    "x"_a, "f"_a, "nx"_a, "mx"_a, "func_num"_a);
    m.def("cec21_rot_func", &cec21_rot_func,
    "Rotation",
    "x"_a, "f"_a, "nx"_a, "mx"_a, "func_num"_a);
    m.def("cec21_shift_func", &cec21_shift_func,
    "Shift",
    "x"_a, "f"_a, "nx"_a, "mx"_a, "func_num"_a);
    m.def("cec21_shift_rot_func", &cec21_shift_rot_func,
    "Shift & Rotation",
    "x"_a, "f"_a, "nx"_a, "mx"_a, "func_num"_a);
}
